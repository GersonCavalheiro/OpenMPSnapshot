...
return 0;
id = 0;
if (length == 13 && count_base64 == 13) 
id = 1;
else
if (length == 13 && count_base64_2 == 11) 
id = 2;
else
if (length >= 13 &&
count_base64_2 >= length - 2 && 
(length - 2) % 11 == 0)
id = 3;
else
...
memcpy(pw, ciphertext, pw_length); 
pw[pw_length] = 0;
#if defined(_OPENMP) && defined(__GLIBC__)
{
