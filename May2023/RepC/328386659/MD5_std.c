...
HH (d, a, b, c, x[ 8], S32, AC34);		
HH (c, d, a, b, x[11], S33, AC35);		
HH (b, c, d, a, x[14], S34, AC36);		
HH (a, b, c, d, x[ 1], S31, AC37);		
HH (d, a, b, c, x[ 4], S32, AC38);		
HH (c, d, a, b, x[ 7], S33, AC39);		
HH (b, c, d, a, x[10], S34, AC40);		
HH (a, b, c, d, x[13], S31, AC41);		
HH (d, a, b, c, x[ 0], S32, AC42);		
HH (c, d, a, b, x[ 3], S33, AC43);		
HH (b, c, d, a, x[ 6], S34, AC44);		
HH (a, b, c, d, x[ 9], S31, AC45);		
HH (d, a, b, c, x[12], S32, AC46);		
c += H (d, a, b) + AC47;
ROTATE_LEFT (c, S33); c += d;			
HH (b, c, d, a, x[ 2], S34, AC48);		
