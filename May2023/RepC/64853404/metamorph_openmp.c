...
((events[1].tv_nsec - events[0].tv_nsec) * 0.000001);
} else
ret = 1;
return ret;
}
...
(*(profiling_symbols.metaProfilingCreateTimer))(
&timer, metaModePreferOpenMP,
(*arr_dim_xy)[0] * (*arr_dim_xy)[1] * get_atype_size(type));
if (events == NULL) {
events = ((openmpEvent *)timer->event.event_pl);
} else {
timer->event = *ret_event;
...
int ret = 0; 
openmpEvent *events_k1 = NULL, *events_c1 = NULL, *events_c2 = NULL,
*events_c3 = NULL;
if (ret_event_k1 != NULL && ret_event_k1->mode == metaModePreferOpenMP &&
ret_event_k1->event_pl != NULL)
events_k1 = ((openmpEvent *)ret_event_k1->event_pl);
if (ret_event_c1 != NULL && ret_event_c1->mode == metaModePreferOpenMP &&
ret_event_c1->event_pl != NULL)
events_c1 = ((openmpEvent *)ret_event_c1->event_pl);
if (ret_event_c2 != NULL && ret_event_c2->mode == metaModePreferOpenMP &&
ret_event_c2->event_pl != NULL)
events_c2 = ((openmpEvent *)ret_event_c2->event_pl);
if (ret_event_c3 != NULL && ret_event_c3->mode == metaModePreferOpenMP &&
ret_event_c3->event_pl != NULL)
events_c3 = ((openmpEvent *)ret_event_c3->event_pl);
meta_timer *timer_k1 = NULL, *timer_c1 = NULL, *timer_c2 = NULL,
*timer_c3 = NULL;
if (profiling_symbols.metaProfilingCreateTimer != NULL) {
(*(profiling_symbols.metaProfilingCreateTimer))(
&timer_k1, metaModePreferOpenMP,
get_atype_size(type) * face->size[0] * face->size[1] * face->size[2]);
(*(profiling_symbols.metaProfilingCreateTimer))(
&timer_c1, metaModePreferOpenMP, get_atype_size(type) * 3);
(*(profiling_symbols.metaProfilingCreateTimer))(
&timer_c2, metaModePreferOpenMP, get_atype_size(type) * 3);
(*(profiling_symbols.metaProfilingCreateTimer))(
&timer_c3, metaModePreferOpenMP, get_atype_size(type) * 3);
if (events_k1 == NULL) {
