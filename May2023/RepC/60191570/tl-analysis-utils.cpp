...
if(Nodecl::Utils::structurally_equal_nodecls(nodecl, *it, true))
return true;
return false;
}
...
if (Nodecl::Utils::structurally_equal_nodecls(n, sub, true))
{
...
{
sub1 = sub1.no_conv();
if (Nodecl::Utils::structurally_equal_nodecls(n, sub1, true))
{
...
{
sub2 = sub2.no_conv();
if (Nodecl::Utils::structurally_equal_nodecls(n, sub2, true))
{
...
{
if (Nodecl::Utils::structurally_equal_nodecls(itr1->first, itr2->first, true)
&& Nodecl::Utils::structurally_equal_nodecls(itr1->second.first, itr2->second.first, true))
goto next_it;
}
return false;
