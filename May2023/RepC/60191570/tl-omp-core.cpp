...
_data_environment.get_data_sharing(sym,  false);
...
{
TL::Symbol &sym(*it);
DataSharingValue data_sharing = data_environment.get_data_sharing(sym,  false);
...
continue;
data_sharing = data_environment.get_data_sharing(sym,  false);
if (data_sharing.attr == DS_UNDEFINED)
{
...
data_environment.get_data_sharing(sym,  false);
...
DataSharingAttribute default_data_attr = get_default_data_sharing(pragma_line,  DS_SHARED,
...
{
DataSharingValue ds = enclosing->get_data_sharing(sym,  false);
...
pragma_line,  loop, default_data_attr,
data_environment, extra_symbols);
