...
static void make_empty_csr(temp_csr_graph* restrict const outg ) {
...
static void make_csr(const packed_edge* restrict const inbuf, temp_csr_graph* restrict const outg ) {
...
temp_csr_graph t = { \
(size_t*)xmalloc((size_t)(nlocalverts_so_far + 1) * sizeof(size_t)), \
