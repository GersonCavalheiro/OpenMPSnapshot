...
void saveMapToFile(struct mapChain* mapTable, int capacity, int thread){
...
void convertMap(struct mapChain* mapTable, char* mapString, int* mapCount, int capacity, int tableIter, int clusterSize){
