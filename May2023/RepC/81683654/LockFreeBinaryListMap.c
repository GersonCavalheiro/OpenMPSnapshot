#define _GNU_SOURCE
#include <sched.h>
#include"LockFreeBinaryListMap.h"
...
int prev_map_size=0;
#pragma omp parallel firstprivate(i,input_array,reduction) shared(map, start, prev_map_size, thread_ending, thread_using, node_inserted)
{	
cpu_set_t mask;
CPU_ZERO(&mask);
