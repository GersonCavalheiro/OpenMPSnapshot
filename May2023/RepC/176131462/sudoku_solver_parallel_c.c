...
int solveSudoku(int row, int col, int matrix[MAX_SIZE][MAX_SIZE], int box_sz, int grid_sz,int *found) 
{ 
if(col > (box_sz - 1)) {
col = 0;
row++;
...
if (solveSudoku(row, col+1, matrix, box_sz, grid_sz, found)) { 
...
if(*found == 0)
{ 				
if (solveSudoku(row, col+1, tempMatrix, box_sz, grid_sz, found)) 
{
