...
#  endif
#pragma omp parallel num_threads(thread_count) default(none) shared(curr,forces,thread_count,delta_t,n,n_steps, output_freq,loc_forces) private(step, part, t)
{
