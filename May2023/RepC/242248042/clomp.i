...
print_pseudocode ("Manual OMP", "{");
print_pseudocode ("Manual OMP", "   int startPidx = ... ");
print_pseudocode ("Manual OMP", "   for (iter = 0; iter < num_iterations; iter++) ");
print_pseudocode ("Manual OMP", "      do_iter(startPidx, endPidx);");
print_pseudocode ("Manual OMP", "}" );
print_pseudocode ("Manual OMP", "..." );
print_pseudocode ("Manual OMP", "do_modN(int startPidx, int endPidx) " );
print_pseudocode ("Manual OMP", "{");
print_pseudocode ("Manual OMP", "  #pragma omp barrier ");
print_pseudocode ("Manual OMP", "  #pragma omp single  ");
print_pseudocode ("Manual OMP", "  {");
print_pseudocode ("Manual OMP", "    deposit = calc_deposit (); ");
print_pseudocode ("Manual OMP", "  }  ");
print_pseudocode ("Manual OMP", "  ");
