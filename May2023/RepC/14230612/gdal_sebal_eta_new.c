...
GDALDatasetH hD14 = GDALOpen(inB14,GA_ReadOnly);
GDALDatasetH hD15 = GDALOpen(inB15,GA_ReadOnly);
GDALDatasetH hD16 = GDALOpen(inB16,GA_ReadOnly);
GDALDatasetH hD17 = GDALOpen(inB17,GA_ReadOnly);
...
float Rn, g0;
float ndvi_max=0.0;
float albedo_max=0.0001, albedo_min=0.9999;
double dt;
...
#pragma omp parallel for default(none) private(rowcol, tempk, etpotd, Rn, g0, dem, t0dem,)shared(N, nX,  nY, roh_w, tsw, doy, u2m,t0dem_min,t0dem_max,dtdry_min,dtdry_max,ndvi_max,albedo_min,albedo_max, mat1,mat2,mat8,mat14, mat15,mat16, mat17, matdtdry, matOut3 )
...
#pragma omp parallel for default(none) private(rowcol, tempk, etpotd, Rn, g0, dem, t0dem,index)shared(N,index_min, index_max,t0dem_min, t0dem_max, dtdry_max, dtdry_min,albedo_min,albedo_max, i_bottom1a, i_peak3,Rn_dry, g0_dry, Rn_wet, g0_wet, t0dem_wet, t0dem_dry,dem_dry, mat2,mat8,mat14,mat15,mat16,mat17,matdtdry, matdtdryidx, matalbidx, matevapfrsseb, matOut3 )
for(rowcol=0;rowcol<N;rowcol++){
tempk = mat8[rowcol] * 0.02;
dem = mat14[rowcol];
t0dem = tempk + 0.00627 * dem;
...
float score=0.0;
int score_max=1;
#pragma omp parallel for default(none) private (rowcol, h0, dt) shared (N,iteration,ndvi_max,Rn_dry,g0_dry,score,score_max, t0dem_wet,t0dem_dry,u2m,doy,dem_dry, mat1,mat2,mat8,mat14,mat15,mat16,mat17, matOut4,matOut5,matOut6,matOut7)
for(rowcol=0;rowcol<N;rowcol++){
