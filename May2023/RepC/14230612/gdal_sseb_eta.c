...
#pragma omp parallel for default(none) private(n)shared(N, mat1, lst_h, lst_c )
for(n=0;n<N;n++){
...
#pragma omp barrier
printf("cold=%f\thot=%f\n",lst_c,lst_h);
#pragma omp parallel for default(none) private(n, ssebeta, ssebevapfr, ssebtheta)shared(N, lst_h, lst_c, mat1, mat2, matOut1, matOut0, matOut )
for(n=0;n<N;n++){
