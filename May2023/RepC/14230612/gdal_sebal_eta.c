...
float ndvi_max=0.0, albedo_max=0.001, albedo_min=0.9;
double dt;
...
#pragma omp parallel for default(none) private(rowcol, tempk, etpotd)shared(N, nX, nY, roh_w, tsw, doy,ndvi_max,albedo_min,albedo_max, mat1,mat2,mat8, mat15, matOut3 )
...
float score=0.0;
int score_max=0;
#pragma omp parallel for default(none) private (rowcol, h0, dt) shared (N,iteration,ndvi_max,Rn_dry,g0_dry,doy,score,score_max, t0dem_wet,t0dem_dry,u2m,dem_dry,tempk_wet,tempk_dry, mat1,mat2,mat8,mat14,mat15,mat16,mat17, matOut4,matOut5,matOut6,matOut7)
for(rowcol=0;rowcol<N;rowcol++){
