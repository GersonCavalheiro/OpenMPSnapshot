...
double a, b; 
#pragma omp parallel for default(none) private (rowcol,temp) shared (N, dfs, l1, l2, l3, lOut,histogram)
...
b=0;
printf("a= %f\tb= %f\n",a,b);
#pragma omp parallel for default(none) private (rowcol) shared (N, lOut, a, b)
for(rowcol=0;rowcol<N;rowcol++)
