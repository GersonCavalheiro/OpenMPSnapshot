...
#define AVX512_MASK_BITWISE_AND_NOT(X,Y)          _mm512_kandn(X,Y)  
#define AVX512_MASK_BITWISE_NOT(X,Y)              _mm512_knot(X) 
...
#define AVX512_BLEND_INTS_WITH_MASK(MASK, FALSE,TRUE)             _mm256_blend_epi32(FALSE, TRUE, MASK)
#else
...
AVX512_FNMA_ADD_FLOATS(denominator, rc_iter, two)); \
}                                                             \
