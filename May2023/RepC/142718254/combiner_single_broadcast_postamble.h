...
#endif
#ifdef IP_ENABLE_THREAD_PROFILING
#pragma omp parallel default(none) shared(ip_active_vertices, ip_all_neighbour_extras, ip_thread_count, timer_compute_start, timer_compute_stop, timer_compute_total, timer_fetching_start, timer_fetching_stop, timer_fetching_total, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#else
#pragma omp parallel default(none) shared(ip_active_vertices, ip_all_neighbour_extras, ip_thread_count, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#endif
{
