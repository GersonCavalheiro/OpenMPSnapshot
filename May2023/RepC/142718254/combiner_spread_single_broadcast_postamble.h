...
#endif
#ifdef IP_ENABLE_THREAD_PROFILING
#pragma omp parallel default(none) shared(ip_all_targets, ip_thread_count, ip_all_externalised_structures_1, ip_all_externalised_structures_2, ip_active_vertices, timer_compute_start, timer_compute_stop, timer_compute_total, timer_target_filtering_start, timer_target_filtering_stop, timer_target_filtering_total, timer_message_fetching_start, timer_message_fetching_stop, timer_message_fetching_total, timer_state_reseting_start, timer_state_reseting_stop, timer_state_reseting_total, timer_edge_count, timer_edge_count_total, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#else
#pragma omp parallel default(none) shared(ip_all_targets, ip_thread_count, ip_all_externalised_structures_1, ip_all_externalised_structures_2, ip_active_vertices, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#endif
{	
