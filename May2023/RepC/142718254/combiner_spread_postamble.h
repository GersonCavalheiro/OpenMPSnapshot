...
#endif
#ifdef IP_ENABLE_THREAD_PROFILING
#pragma omp parallel default(none) shared(ip_active_vertices, ip_all_spread_vertices, ip_all_spread_vertices_omp, ip_thread_count, ip_all_externalised_structures, timer_compute_start, timer_compute_stop, timer_compute_total, timer_spread_merge_start, timer_spread_merge_stop, timer_spread_merge_total, timer_mailbox_update_start, timer_mailbox_update_stop, timer_mailbox_update_total, timer_edge_count, timer_edge_count_total, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#else
#pragma omp parallel default(none) shared(ip_active_vertices, ip_all_spread_vertices, ip_all_spread_vertices_omp, ip_thread_count, ip_all_externalised_structures, timer_superstep_total, timer_superstep_start, timer_superstep_stop)
#endif
{
