...
uint32_t P = arguments->algo_numThreads;
uint32_t mu = graph->num_edges; 
uint32_t mf = graph->vertices->out_degree[arguments->source]; 
uint32_t nf = 0; 
uint32_t nf_prev = 0; 
...
totalPartitions = graph->grid->num_partitions; 
uint32_t i;
...
uint32_t P = arguments->algo_numThreads;
uint32_t mu = graph->num_edges; 
uint32_t mf = graph->vertices[arguments->source].out_degree; 
uint32_t nf = 0; 
uint32_t nf_prev = 0; 
uint32_t n = graph->num_vertices; 
uint32_t alpha = 15;
