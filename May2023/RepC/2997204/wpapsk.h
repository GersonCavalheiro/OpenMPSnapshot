...
HMACMD5Context ctx;
prf_512(outbuffer[i].v, data, prf.u32); 
...
size_t miclen;
CMAC_CTX *ctx;
sha256_prf_bits((unsigned char*)outbuffer[i].v, 32, "Pairwise key expansion", data, 76, ptk, 48 * 8); 
ctx = CMAC_CTX_new();
