...
a = AC1 + x[0];
ROTATE_LEFT (a, S11); a += b;			
d = (c ^ (a & MASK1)) + x[1] + AC2pCd;
ROTATE_LEFT (d, S12); d += a;			
c = F(d, a, b) + x[2] + AC3pCc;
ROTATE_LEFT(c, S13); c += d;			
b = F(c, d, a) + x[3] + AC4pCb;
ROTATE_LEFT(b, S14); b += c;			
FF (a, b, c, d, x[ 4], S11, AC5);		
FF (d, a, b, c, x[ 5], S12, AC6);		
FF (c, d, a, b, x[ 6], S13, AC7);		
FF (b, c, d, a, x[ 7], S14, AC8);		
FF (a, b, c, d, x[ 8], S11, AC9);		
FF (d, a, b, c, x[ 9], S12, AC10);		
FF (c, d, a, b, x[10], S13, AC11);		
FF (b, c, d, a, x[11], S14, AC12);		
FF (a, b, c, d, x[12], S11, AC13);		
FF (d, a, b, c, x[13], S12, AC14);		
FF (c, d, a, b, x[14], S13, AC15);		
b += F (c, d, a) + AC16;
ROTATE_LEFT (b, S14); b += c;			
GG (a, b, c, d, x[ 1], S21, AC17);		
GG (d, a, b, c, x[ 6], S22, AC18);		
GG (c, d, a, b, x[11], S23, AC19);		
GG (b, c, d, a, x[ 0], S24, AC20);		
GG (a, b, c, d, x[ 5], S21, AC21);		
GG (d, a, b, c, x[10], S22, AC22);		
c += G (d, a, b) + AC23;
ROTATE_LEFT (c, S23); c += d;			
GG (b, c, d, a, x[ 4], S24, AC24);		
GG (a, b, c, d, x[ 9], S21, AC25);		
GG (d, a, b, c, x[14], S22, AC26);		
GG (c, d, a, b, x[ 3], S23, AC27);		
GG (b, c, d, a, x[ 8], S24, AC28);		
GG (a, b, c, d, x[13], S21, AC29);		
GG (d, a, b, c, x[ 2], S22, AC30);		
GG (c, d, a, b, x[ 7], S23, AC31);		
GG (b, c, d, a, x[12], S24, AC32);		
HH (a, b, c, d, x[ 5], S31, AC33);		
HH2 (d, a, b, c, x[ 8], S32, AC34);		
HH (c, d, a, b, x[11], S33, AC35);		
HH2 (b, c, d, a, x[14], S34, AC36);		
HH (a, b, c, d, x[ 1], S31, AC37);		
HH2 (d, a, b, c, x[ 4], S32, AC38);		
HH (c, d, a, b, x[ 7], S33, AC39);		
HH2 (b, c, d, a, x[10], S34, AC40);		
HH (a, b, c, d, x[13], S31, AC41);		
HH2 (d, a, b, c, x[ 0], S32, AC42);		
HH (c, d, a, b, x[ 3], S33, AC43);		
HH2 (b, c, d, a, x[ 6], S34, AC44);		
HH (a, b, c, d, x[ 9], S31, AC45);		
HH2 (d, a, b, c, x[12], S32, AC46);		
c += H (d, a, b) + AC47;
ROTATE_LEFT (c, S33); c += d;			
HH2 (b, c, d, a, x[ 2], S34, AC48);		
II (a, b, c, d, x[ 0], S41, AC49);		
II (d, a, b, c, x[ 7], S42, AC50);		
II (c, d, a, b, x[14], S43, AC51);		
II (b, c, d, a, x[ 5], S44, AC52);		
II (a, b, c, d, x[12], S41, AC53);		
II (d, a, b, c, x[ 3], S42, AC54);		
II (c, d, a, b, x[10], S43, AC55);		
II (b, c, d, a, x[ 1], S44, AC56);		
II (a, b, c, d, x[ 8], S41, AC57);		
d += I (a, b, c) + AC58;
ROTATE_LEFT (d, S42); d += a;			
II (c, d, a, b, x[ 6], S43, AC59);		
II (b, c, d, a, x[13], S44, AC60);		
II (a, b, c, d, x[ 4], S41, AC61);		
II (d, a, b, c, x[11], S42, AC62);		
II (c, d, a, b, x[ 2], S43, AC63);		
II (b, c, d, a, x[ 9], S44, AC64);		
out[0] = Ca + a;
out[1] = Cb + b;
out[2] = Cc + c;
out[3] = Cd + d;
...
MD5_word u, v;
a0 = (u = AC1) + x0[0];
ROTATE_LEFT (a0, S11); a0 += b0;		
a1 = u + x1[0];
ROTATE_LEFT (a1, S11); a1 += b0;		
d0 = (c0 ^ (a0 & (u = MASK1))) + x0[1] + (v = AC2pCd);
ROTATE_LEFT (d0, S12); d0 += a0;		
d1 = (c0 ^ (a1 & u)) + x1[1] + v;
ROTATE_LEFT (d1, S12); d1 += a1;		
c0 = F(d0, a0, b0) + x0[2] + (u = AC3pCc);
ROTATE_LEFT(c0, S13); c0 += d0;			
c1 = F(d1, a1, b0) + x1[2] + u;
ROTATE_LEFT(c1, S13); c1 += d1;			
b0 = F(c0, d0, a0) + x0[3] + (u = AC4pCb);
ROTATE_LEFT(b0, S14); b0 += c0;			
b1 = F(c1, d1, a1) + x1[3] + u;
ROTATE_LEFT(b1, S14); b1 += c1;			
FF (a0, b0, c0, d0, x0[ 4], S11, (u = AC5));	
FF (a1, b1, c1, d1, x1[ 4], S11, u);		
FF (d0, a0, b0, c0, x0[ 5], S12, (u = AC6));	
FF (d1, a1, b1, c1, x1[ 5], S12, u);		
FF (c0, d0, a0, b0, x0[ 6], S13, (u = AC7));	
FF (c1, d1, a1, b1, x1[ 6], S13, u);		
FF (b0, c0, d0, a0, x0[ 7], S14, (u = AC8));	
FF (b1, c1, d1, a1, x1[ 7], S14, u);		
FF (a0, b0, c0, d0, x0[ 8], S11, (u = AC9));	
FF (a1, b1, c1, d1, x1[ 8], S11, u);		
FF (d0, a0, b0, c0, x0[ 9], S12, (u = AC10));	
FF (d1, a1, b1, c1, x1[ 9], S12, u);		
FF (c0, d0, a0, b0, x0[10], S13, (u = AC11));	
FF (c1, d1, a1, b1, x1[10], S13, u);		
FF (b0, c0, d0, a0, x0[11], S14, (u = AC12));	
FF (b1, c1, d1, a1, x1[11], S14, u);		
FF (a0, b0, c0, d0, x0[12], S11, (u = AC13));	
FF (a1, b1, c1, d1, x1[12], S11, u);		
FF (d0, a0, b0, c0, x0[13], S12, (u = AC14));	
FF (d1, a1, b1, c1, x1[13], S12, u);		
FF (c0, d0, a0, b0, x0[14], S13, (u = AC15));	
FF (c1, d1, a1, b1, x1[14], S13, u);		
b0 += F (c0, d0, a0) + (u = AC16);
ROTATE_LEFT (b0, S14); b0 += c0;		
b1 += F (c1, d1, a1) + u;
ROTATE_LEFT (b1, S14); b1 += c1;		
GG (a0, b0, c0, d0, x0[ 1], S21, (u = AC17));	
GG (a1, b1, c1, d1, x1[ 1], S21, u);		
GG (d0, a0, b0, c0, x0[ 6], S22, (u = AC18));	
GG (d1, a1, b1, c1, x1[ 6], S22, u);		
GG (c0, d0, a0, b0, x0[11], S23, (u = AC19));	
GG (c1, d1, a1, b1, x1[11], S23, u);		
GG (b0, c0, d0, a0, x0[ 0], S24, (u = AC20));	
GG (b1, c1, d1, a1, x1[ 0], S24, u);		
GG (a0, b0, c0, d0, x0[ 5], S21, (u = AC21));	
GG (a1, b1, c1, d1, x1[ 5], S21, u);		
GG (d0, a0, b0, c0, x0[10], S22, (u = AC22));	
GG (d1, a1, b1, c1, x1[10], S22, u);		
c0 += G (d0, a0, b0) + (u = AC23);
ROTATE_LEFT (c0, S23); c0 += d0;		
c1 += G (d1, a1, b1) + u;
ROTATE_LEFT (c1, S23); c1 += d1;		
GG (b0, c0, d0, a0, x0[ 4], S24, (u = AC24));	
GG (b1, c1, d1, a1, x1[ 4], S24, u);		
GG (a0, b0, c0, d0, x0[ 9], S21, (u = AC25));	
GG (a1, b1, c1, d1, x1[ 9], S21, u);		
GG (d0, a0, b0, c0, x0[14], S22, (u = AC26));	
GG (d1, a1, b1, c1, x1[14], S22, u);		
GG (c0, d0, a0, b0, x0[ 3], S23, (u = AC27));	
GG (c1, d1, a1, b1, x1[ 3], S23, u);		
GG (b0, c0, d0, a0, x0[ 8], S24, (u = AC28));	
GG (b1, c1, d1, a1, x1[ 8], S24, u);		
GG (a0, b0, c0, d0, x0[13], S21, (u = AC29));	
GG (a1, b1, c1, d1, x1[13], S21, u);		
GG (d0, a0, b0, c0, x0[ 2], S22, (u = AC30));	
GG (d1, a1, b1, c1, x1[ 2], S22, u);		
GG (c0, d0, a0, b0, x0[ 7], S23, (u = AC31));	
GG (c1, d1, a1, b1, x1[ 7], S23, u);		
GG (b0, c0, d0, a0, x0[12], S24, (u = AC32));	
GG (b1, c1, d1, a1, x1[12], S24, u);		
HH (a0, b0, c0, d0, x0[ 5], S31, (u = AC33));	
HH (a1, b1, c1, d1, x1[ 5], S31, u);		
HH (d0, a0, b0, c0, x0[ 8], S32, (u = AC34));	
HH (d1, a1, b1, c1, x1[ 8], S32, u);		
HH (c0, d0, a0, b0, x0[11], S33, (u = AC35));	
HH (c1, d1, a1, b1, x1[11], S33, u);		
HH (b0, c0, d0, a0, x0[14], S34, (u = AC36));	
HH (b1, c1, d1, a1, x1[14], S34, u);		
HH (a0, b0, c0, d0, x0[ 1], S31, (u = AC37));	
HH (a1, b1, c1, d1, x1[ 1], S31, u);		
HH (d0, a0, b0, c0, x0[ 4], S32, (u = AC38));	
HH (d1, a1, b1, c1, x1[ 4], S32, u);		
HH (c0, d0, a0, b0, x0[ 7], S33, (u = AC39));	
HH (c1, d1, a1, b1, x1[ 7], S33, u);		
HH (b0, c0, d0, a0, x0[10], S34, (u = AC40));	
HH (b1, c1, d1, a1, x1[10], S34, u);		
HH (a0, b0, c0, d0, x0[13], S31, (u = AC41));	
HH (a1, b1, c1, d1, x1[13], S31, u);		
HH (d0, a0, b0, c0, x0[ 0], S32, (u = AC42));	
HH (d1, a1, b1, c1, x1[ 0], S32, u);		
HH (c0, d0, a0, b0, x0[ 3], S33, (u = AC43));	
HH (c1, d1, a1, b1, x1[ 3], S33, u);		
HH (b0, c0, d0, a0, x0[ 6], S34, (u = AC44));	
HH (b1, c1, d1, a1, x1[ 6], S34, u);		
HH (a0, b0, c0, d0, x0[ 9], S31, (u = AC45));	
HH (a1, b1, c1, d1, x1[ 9], S31, u);		
HH (d0, a0, b0, c0, x0[12], S32, (u = AC46));	
HH (d1, a1, b1, c1, x1[12], S32, u);		
c0 += H (d0, a0, b0) + (u = AC47);
ROTATE_LEFT (c0, S33); c0 += d0;		
c1 += H (d1, a1, b1) + u;
ROTATE_LEFT (c1, S33); c1 += d1;		
HH (b0, c0, d0, a0, x0[ 2], S34, (u = AC48));	
HH (b1, c1, d1, a1, x1[ 2], S34, u);		
II (a0, b0, c0, d0, x0[ 0], S41, (u = AC49));	
II (a1, b1, c1, d1, x1[ 0], S41, u);		
II (d0, a0, b0, c0, x0[ 7], S42, (u = AC50));	
II (d1, a1, b1, c1, x1[ 7], S42, u);		
II (c0, d0, a0, b0, x0[14], S43, (u = AC51));	
II (c1, d1, a1, b1, x1[14], S43, u);		
II (b0, c0, d0, a0, x0[ 5], S44, (u = AC52));	
II (b1, c1, d1, a1, x1[ 5], S44, u);		
II (a0, b0, c0, d0, x0[12], S41, (u = AC53));	
II (a1, b1, c1, d1, x1[12], S41, u);		
II (d0, a0, b0, c0, x0[ 3], S42, (u = AC54));	
II (d1, a1, b1, c1, x1[ 3], S42, u);		
II (c0, d0, a0, b0, x0[10], S43, (u = AC55));	
II (c1, d1, a1, b1, x1[10], S43, u);		
II (b0, c0, d0, a0, x0[ 1], S44, (u = AC56));	
II (b1, c1, d1, a1, x1[ 1], S44, u);		
II (a0, b0, c0, d0, x0[ 8], S41, (u = AC57));	
II (a1, b1, c1, d1, x1[ 8], S41, u);		
d0 += I (a0, b0, c0) + (u = AC58);
ROTATE_LEFT (d0, S42); d0 += a0;		
d1 += I (a1, b1, c1) + u;
ROTATE_LEFT (d1, S42); d1 += a1;		
II (c0, d0, a0, b0, x0[ 6], S43, (u = AC59));	
II (c1, d1, a1, b1, x1[ 6], S43, u);		
II (b0, c0, d0, a0, x0[13], S44, (u = AC60));	
II (b1, c1, d1, a1, x1[13], S44, u);		
II (a0, b0, c0, d0, x0[ 4], S41, (u = AC61));	
II (a1, b1, c1, d1, x1[ 4], S41, u);		
II (d0, a0, b0, c0, x0[11], S42, (u = AC62));	
II (d1, a1, b1, c1, x1[11], S42, u);		
II (c0, d0, a0, b0, x0[ 2], S43, (u = AC63));	
II (c1, d1, a1, b1, x1[ 2], S43, u);		
II (b0, c0, d0, a0, x0[ 9], S44, (u = AC64));	
II (b1, c1, d1, a1, x1[ 9], S44, u);		
out1[3] = Cd + d1;
out0[0] = Ca + a0;
out0[1] = Cb + b0;
out0[2] = Cc + c0;
