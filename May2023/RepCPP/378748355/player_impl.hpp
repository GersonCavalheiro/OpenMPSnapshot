...
PacketHelper::broadcastToStreamed(setPlayerTeamRPC, *this, false );
}
...
{
PacketHelper::broadcastToStreamed(clearPlayerTasksRPC, *this, false );
}
...
PacketHelper::broadcastToStreamed(setPlayerSkillLevelRPC, *this, false );
}
}
...
RPC.Text = text;
PacketHelper::broadcastToStreamed(RPC, *this, true );
}
