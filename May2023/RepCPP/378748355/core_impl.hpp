...
try
{
props = nlohmann::json::parse(ifs, nullptr, true , true );
}
...
Config config(core, true );
components.configure(core, config, true );
...
if (ifs.good())
{
nlohmann::json props = nlohmann::json::parse(ifs, nullptr, false , true );
