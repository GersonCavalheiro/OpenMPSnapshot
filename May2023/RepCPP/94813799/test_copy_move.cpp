...
int r = 0;
r += py::cast<MoveOrCopyInt>(o).value; 
r += py::cast<MoveOnlyInt>(o).value; 
r += py::cast<CopyOnlyInt>(o).value; 
MoveOrCopyInt m1(py::cast<MoveOrCopyInt>(o)); 
MoveOnlyInt m2(py::cast<MoveOnlyInt>(o)); 
CopyOnlyInt m3(py::cast<CopyOnlyInt>(o)); 
