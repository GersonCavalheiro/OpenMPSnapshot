...
class AutoParallelOptions : public ::google::protobuf::Message  {
public:
AutoParallelOptions();
...
class ScopedAllocatorOptions : public ::google::protobuf::Message  {
public:
...
class RewriterConfig_CustomGraphOptimizer : public ::google::protobuf::Message  {
public:
...
class RewriterConfig : public ::google::protobuf::Message  {
public:
RewriterConfig();
