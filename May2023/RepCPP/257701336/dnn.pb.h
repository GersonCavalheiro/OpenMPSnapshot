...
class TensorDescriptorProto : public ::google::protobuf::Message  {
public:
...
class AlgorithmProto : public ::google::protobuf::Message  {
public:
AlgorithmProto();
...
class ConvolutionDescriptorProto : public ::google::protobuf::Message  {
public:
