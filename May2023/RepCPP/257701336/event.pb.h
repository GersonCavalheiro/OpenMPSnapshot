...
class WatchdogConfig : public ::google::protobuf::Message  {
public:
WatchdogConfig();
...
class WorkerHeartbeatRequest : public ::google::protobuf::Message  {
public:
...
class WorkerHeartbeatResponse : public ::google::protobuf::Message  {
public:
