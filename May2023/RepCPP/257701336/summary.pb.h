...
class SummaryDescription : public ::google::protobuf::Message  {
public:
SummaryDescription();
...
class SummaryMetadata_PluginData : public ::google::protobuf::Message  {
public:
...
class SummaryMetadata : public ::google::protobuf::Message  {
public:
SummaryMetadata();
