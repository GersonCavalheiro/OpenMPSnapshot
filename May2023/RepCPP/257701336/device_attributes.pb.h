...
class InterconnectLink : public ::google::protobuf::Message  {
public:
InterconnectLink();
...
class LocalLinks : public ::google::protobuf::Message  {
public:
LocalLinks();
virtual ~LocalLinks();
...
class DeviceLocality : public ::google::protobuf::Message  {
public:
DeviceLocality();
