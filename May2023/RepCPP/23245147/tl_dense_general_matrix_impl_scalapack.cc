...
const std::size_t TlDenseGeneralMatrix_ImplScalapack::FILE_BUFFER_SIZE = 100 * 1024 * 1024;  
...
const int nBlockIndex = this->m_nMyProcRow * nBlockSize;           
const int nIncrementBlockIndex = this->procGridRow_ * nBlockSize;  
...
const int nBlockSize = this->blockSize_;
const int nBlockIndex = this->m_nMyProcCol * this->blockSize_;           
const int nIncrementBlockIndex = this->procGridCol_ * this->blockSize_;  
