...
cv::Mat inputImage = imread(argv[1], cv::IMREAD_UNCHANGED); 
...
cv::Mat locallyEnhancedImageTemp = sharpenedImage.clone();

cv::Mat globallyEnhancedImage = locallyEnhancedImageTemp.clone();
cv::Mat globallyEnhancedImageTemp = locallyEnhancedImage.clone();
...
cv::Mat outputImageTemp = outputImage.clone();
...
double redSc = 0, greenSc = 0, blueSc = 0; 
double h = 0, s = 0, v = 0; 
