...
if( currentWorkspace < firstUserWorkspace[ getCurrentTrace() ] ) 
{
...
zoomInfo.first = property->GetValue().GetDouble(); 
...
pair< TTime, TTime > zoomInfo = whichTimeline->getZoomFirstDimension();
zoomInfo.second = property->GetValue().GetDouble(); 
whichTimeline->setZoomFirstDimension( zoomInfo );
...
zoomInfo.first.begin = property->GetValue().GetDouble(); 
...
pair< HistogramProxy::TZoomInfo, HistogramProxy::TZoomInfo > zoomInfo = whichHistogram->getZoomFirstDimension();
zoomInfo.first.end = property->GetValue().GetDouble(); 
whichHistogram->setZoomFirstDimension( zoomInfo );
...
pair< HistogramProxy::TZoomInfo, HistogramProxy::TZoomInfo > zoomInfo = whichHistogram->getZoomFirstDimension();
zoomInfo.second.begin = property->GetValue().GetDouble(); 
whichHistogram->setZoomFirstDimension( zoomInfo );
...
wxMenu *menu = item->GetSubMenu();
wxMenuItemList& menuItems = menu->GetMenuItems();
wxMenuItemList::iterator menuIt = menuItems.begin(); ++menuIt; ++menuIt; 
...
newWindow->setWidth( defaultWindowSize.GetWidth() ); 
...
bool paraverMain::matchTraceNames( const string &fileName1,  
...
const wxString &helpContentsBaseRelativePath,  
...
<< ZeroTrail( now.time_of_day().seconds() ); 
