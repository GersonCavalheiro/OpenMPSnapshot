...
void TStructuredCovarianceMatrix::PMultiply(const TFltVV& B, int ColId, TFltV& Result) const { FailR("Not implemented yet"); } 
...
void TStructuredCovarianceMatrix::PMultiply(const TFltV& Vec, TFltV& Result) const { FailR("Not implemented yet"); } 

void TStructuredCovarianceMatrix::PMultiplyT(const TFltVV& B, int ColId, TFltV& Result) const { FailR("Not implemented yet"); } 
...
TLinAlgTransform::FillIdentity(S); 
...
H.Clr();
typedef Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Mat;
F.Gen(n, (its + 1) * l); TLinAlgTransform::FillRnd(F);
