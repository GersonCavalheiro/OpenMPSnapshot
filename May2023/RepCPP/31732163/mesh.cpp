...
#pragma omp task
geom.solut.resize((size_t) nb.nodes);  
#pragma omp task
...
memory_print += (capa.bucket * capa.node * sizeof(int)); 
memory_print += (6 * capa.node * sizeof(int));           
memory_print += (3 * capa.elem * sizeof(int));           
memory_print += (2 * capa.node * sizeof(double));        
memory_print += (3 * capa.node * sizeof(double));        
memory_print += (1 * nb.nodes  * sizeof(double));        
memory_print += (1 * capa.elem * sizeof(double));        
memory_print += (1 * capa.node * sizeof(int));           
memory_print += (1 * nb.cores  * sizeof(int));           
memory_print += (1 * capa.elem);                         
memory_print += (1 * capa.node);                         
memory_print += (1 * capa.node);                         
