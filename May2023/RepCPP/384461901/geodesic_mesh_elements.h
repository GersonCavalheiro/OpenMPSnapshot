...
protected:
std::vector<vertex_pointer> m_adjacent_vertices; 
std::vector<edge_pointer> m_adjacent_edges;      
std::vector<face_pointer> m_adjacent_faces;      
...
SurfacePoint(const edge_pointer e, 
double a = 0.5)
: m_p(e)
{
const double b = 1 - a;
