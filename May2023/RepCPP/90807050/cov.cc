...
void mad::cov::accumulate_diagonal(int64_t , int64_t subsize, int64_t nnz,
...
void mad::cov::accumulate_diagonal_hits(int64_t , int64_t subsize,
int64_t , int64_t nsamp,
...
void mad::cov::accumulate_diagonal_invnpp ( int64_t , int64_t subsize,
