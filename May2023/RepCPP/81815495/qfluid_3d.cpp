...
if(FractionalStepNumber  == 5) 
{


BoundedMatrix<double,4,3> msDN_DX;

array_1d<double,12> GalerkinRHS = ZeroVector(12); 
...
else if(FractionalStepNumber == 6) 
{
...
{
array_1d<double,4> temp_vec_np; 
array_1d<double,4> GalerkinRHS = ZeroVector(4); 
BoundedMatrix<double,4,3> msDN_DX; 
...
constexpr double E_over_R = 24400.0;
constexpr double C = 2.18e12;
