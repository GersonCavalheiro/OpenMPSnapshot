...
mStiffnessAlpha = 1.0 - mCMDeltaTime / stiffness_averaging_time_interval; 
...
const double stiffness = this_actuator_parameters["Parameters"]["young_modulus"].GetDouble()/compression_length; 
...
noalias(reaction_stress_estimated) = MeasureReactionStress(CONTACT_FORCES); 
...
noalias(elastic_reaction_stress_estimated) = MeasureReactionStress(ELASTIC_FORCES); 
