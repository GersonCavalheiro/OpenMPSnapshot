...
if ((x_node*x_node + z_node*z_node >= radius*radius && y_node < 0.01) || (x_node*x_node + z_node*z_node >= radius*radius && y_node > 0.07)) {   
...
double radius_it = 0.0225; 
if (x_node_it*x_node_it + z_node_it*z_node_it < radius_it*radius_it) {   
