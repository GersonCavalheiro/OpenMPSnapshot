...
std::vector<ptrdiff_t> send_agg(send_dofs);             
std::vector<ptrdiff_t> send_dof(send_dofs);             
std::vector<double>    send_row(send_dofs * null_cols); 

std::vector<ptrdiff_t> recv_agg(recv_dofs);             
std::vector<ptrdiff_t> recv_dof(recv_dofs);             
std::vector<double>    recv_row(recv_dofs * null_cols); 
