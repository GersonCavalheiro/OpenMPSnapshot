...
noalias(GlobalCoordinates) = itNodeNew->Coordinates(); 
bool IsInside = false;
...
rGeom.GlobalCoordinates(MyGaussPointOld.Coordinates,AuxLocalCoordinates); 
...
AuxLocalCoordinates[1] = IntegrationPoints[GPoint][1];
AuxLocalCoordinates[2] = IntegrationPoints[GPoint][2];
rGeom.GlobalCoordinates(MyFracturePoint.Coordinates,AuxLocalCoordinates); 
...
if (PropagateTop == true && PropagateBot == true) 
{
