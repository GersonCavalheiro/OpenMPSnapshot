...
std::vector<NodeType::Pointer> to_extrapolate_nodes; 
...
if (mThisParameters["echo_level"].GetInt() > 0 || ConvertFramework(mThisParameters["framework"].GetString()) == FrameworkEulerLagrange::LAGRANGIAN) { 
