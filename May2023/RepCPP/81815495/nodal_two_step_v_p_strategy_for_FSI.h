...
if (it == 0)
{
ComputeNodalVolumeAndAssignFlagToElementType(); 
this->InitializeNonLinearIterations();			
}
CalcNodalStrainsAndStresses(); 
...
{
this->SetNeighboursOrderToNode(itNode); 
if (itNode->Is(SOLID))
{
SetNeighboursOrderToSolidNode(itNode); 
}
}
else
{
SetNeighboursOrderToInterfaceNode(itNode); 
}
}
}
