...
return convolute(row, col, muls, high, lowGetter,  0);
};
...
wavelet.prescale =
extractHighBits(val, 2 * iWavelet, 14) & 0x03;
}
break;
default: { 
...
wavelet, finalWavelet, finalWavelet);
...
inline std::pair<int16_t , unsigned int >
