...
template<class real_type>
void construct_grid(
const thrust::host_vector<real_type>& zetaU, 
const thrust::host_vector<real_type>& etaU,  
const thrust::host_vector<real_type>& u_vec,  
const thrust::host_vector<real_type>& zeta_init, 
const thrust::host_vector<real_type>& eta_init, 
