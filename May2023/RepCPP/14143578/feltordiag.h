...
double& jE0, double& jE1, double& jE2, 
...
dN[0], dN[1], dN[2], v.f.projection(), v.tmp[0], 
dN[0], dN[1], dN[2], 0., result); 
...
dN[0], dN[1], dN[2], v.f.projection(), 1., 
dN[0], dN[1], dN[2], 0., result); 
...
[]( dg::x::DVec& result, Variables& v){
routines::times(v.f.bhatgB(), v.f.gradP(1), v.tmp); 
dg::blas1::pointwiseDot( v.p.mu[1], v.f.density(1), v.f.velocity(1), 0., v.tmp3[0]);
v.f.centered_div( v.tmp3[0], v.tmp, v.tmp2[0], result);
}
},
...
[]( dg::x::DVec& result, Variables& v) {
routines::times(v.f.bhatgB(), v.f.gradP(0), v.tmp2); 
dg::blas1::pointwiseDot(1., v.f.binv(), v.f.binv(), v.f.density(0), 0., v.tmp[0]);
routines::scal(v.tmp[0], v.f.gradP(0), v.tmp3); 
v.f.centered_v_dot_nabla(v.tmp3, v.tmp2[0], v.tmp[2], v.tmp[0]); 
v.f.centered_v_dot_nabla(v.tmp3, v.tmp2[1], v.tmp[2], v.tmp[1]); 
...
[]( dg::x::DVec& result, Variables& v) {
routines::times(v.f.bhatgB(), v.f.gradP(0), v.tmp2); 
v.f.centered_v_dot_nabla(v.f.gradN(0), v.tmp2[0], v.tmp[2], v.tmp[0]); 
v.f.centered_v_dot_nabla(v.f.gradN(0), v.tmp2[1], v.tmp[2], v.tmp[1]); 
...
[]( dg::x::DVec& result, Variables& v) {
routines::times(v.f.bhatgB(), v.f.gradP(0), v.tmp2); 
v.f.centered_v_dot_nabla(v.f.gradN(1), v.tmp2[0], v.tmp[2], v.tmp[0]); 
v.f.centered_v_dot_nabla(v.f.gradN(1), v.tmp2[1], v.tmp[2], v.tmp[1]); 
v.f.centered_div( v.p.tau[1]*v.p.mu[1], v.tmp, v.tmp2[0], result);
}
},
