...
{return n->get_d_out(enter, res_function, correct_summation); }); 
...
{return n->get_out(enter, res_function, correct_summation); }); 
}
...
void set_activation_function (const string &name, const vector<double>& parameters = {}) 
{
...
void set_activation_function (activation_function activ_f) 
{
if (activ_f != nullptr)
res_function = get_activation_function(activ_f);
return;
