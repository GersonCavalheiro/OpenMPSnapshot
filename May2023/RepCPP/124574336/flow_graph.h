...
template< typename T, typename U > class limiter_node;  
...
tmp->ltask = combine_tasks(g, z, new_task);  
}
}
}  
...
class indexer_node : public internal::unfolded_indexer_node<tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> > {
private:
