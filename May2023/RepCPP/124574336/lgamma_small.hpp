...
template <class T, class Policy, class Lanczos>
T lgamma_small_imp(T z, T zm1, T zm2, const boost::integral_constant<int, 64>&, const Policy& , const Lanczos&)
{
...
template <class T, class Policy, class Lanczos>
T lgamma_small_imp(T z, T zm1, T zm2, const boost::integral_constant<int, 113>&, const Policy& , const Lanczos&)
{
BOOST_MATH_STD_USING  
T result = 0;
if(z < tools::epsilon<T>())
