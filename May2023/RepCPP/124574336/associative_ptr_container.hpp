...
#ifndef BOOST_NO_AUTO_PTR
template< class PtrContainer >
associative_ptr_container& operator=( std::auto_ptr<PtrContainer> r ) 
{
...
#ifndef BOOST_NO_CXX11_SMART_PTR
template< class PtrContainer >
associative_ptr_container& operator=( std::unique_ptr<PtrContainer> r ) 
{
...
associative_ptr_container& operator=( associative_ptr_container r ) 
{
this->swap( r );
return *this;   
}
...
this->base().erase( first.base(), last.base() );     
return res;                                          
}
...
this->base().insert( *first.base() );     
BOOST_DEDUCED_TYPENAME AssociatePtrCont::iterator 
to_delete( first );
++first;
from.base().erase( to_delete.base() );    
++res;
}
