...
template<class T> inline bool atomic_is_lock_free( shared_ptr<T> const *  ) BOOST_SP_NOEXCEPT
{
return false;
}
...
template<class T, class M> inline shared_ptr<T> atomic_load_explicit( shared_ptr<T> const * p,  M ) BOOST_SP_NOEXCEPT
{
...
template<class T, class M> inline void atomic_store_explicit( shared_ptr<T> * p, shared_ptr<T> r,  M ) BOOST_SP_NOEXCEPT
{
atomic_store( p, r ); 
}
...
template<class T, class M> shared_ptr<T> inline atomic_exchange_explicit( shared_ptr<T> * p, shared_ptr<T> r,  M ) BOOST_SP_NOEXCEPT
{
...
template<class T, class M> inline bool atomic_compare_exchange_explicit( shared_ptr<T> * p, shared_ptr<T> * v, shared_ptr<T> w,  M,  M ) BOOST_SP_NOEXCEPT
{
