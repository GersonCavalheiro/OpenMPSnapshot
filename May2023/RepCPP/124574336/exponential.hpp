...
template <class RealType, class Policy>
inline const std::pair<RealType, RealType> range(const exponential_distribution<RealType, Policy>& )
{ 
...
template <class RealType, class Policy>
inline const std::pair<RealType, RealType> support(const exponential_distribution<RealType, Policy>& )
{ 
using boost::math::tools::max_value;
...
template <class RealType, class Policy>
inline RealType mode(const exponential_distribution<RealType, Policy>& )
{
return 0;
}
...
return ln_two<RealType>() / dist.lambda(); 
}

template <class RealType, class Policy>
inline RealType skewness(const exponential_distribution<RealType, Policy>& )
{
return 2;
}

template <class RealType, class Policy>
inline RealType kurtosis(const exponential_distribution<RealType, Policy>& )
{
return 9;
}

template <class RealType, class Policy>
inline RealType kurtosis_excess(const exponential_distribution<RealType, Policy>& )
{
return 6;
}
