...
template< class U >
void push_back( std::unique_ptr<U> ptr ) 
{
push_back( ptr.release() );
}
#endif
...
#ifndef BOOST_NO_CXX11_SMART_PTR
template< class U >
void push_front( std::unique_ptr<U> ptr ) 
{
push_front( ptr.release() );
}
#endif
...
#ifndef BOOST_NO_CXX11_SMART_PTR
template< class U >
iterator insert( iterator pos, std::unique_ptr<U> ptr ) 
{
return insert( pos, ptr.release() );
}
#endif
...
#ifndef BOOST_NO_CXX11_SMART_PTR
template< class U >
iterator rinsert( iterator pos, std::unique_ptr<U> ptr ) 
{
return rinsert( pos, ptr.release() );
}
#endif
