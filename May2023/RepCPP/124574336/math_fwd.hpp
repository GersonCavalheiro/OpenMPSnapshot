...
typedef boost::integral_constant<int, 0> bessel_no_int_tag;      
typedef boost::integral_constant<int, 1> bessel_maybe_int_tag;   
typedef boost::integral_constant<int, 2> bessel_int_tag;         
