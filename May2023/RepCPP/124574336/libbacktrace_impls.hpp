...
inline void libbacktrace_syminfo_callback(void *data, uintptr_t , const char *symname, uintptr_t , uintptr_t ) {
...
inline int libbacktrace_full_callback(void *data, uintptr_t , const char *filename, int lineno, const char *function) {
pc_data& d = *static_cast<pc_data*>(data);
...
inline void libbacktrace_error_callback(void* , const char* , int ) BOOST_NOEXCEPT {
}
...
bool prepare_source_location(const void* ) {
