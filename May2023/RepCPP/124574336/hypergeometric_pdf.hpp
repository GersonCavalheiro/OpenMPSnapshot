...
T hypergeometric_pdf_lanczos_imp(T , unsigned x, unsigned r, unsigned n, unsigned N, const Lanczos&, const Policy&)
{
...
T hypergeometric_pdf_lanczos_imp(T , unsigned x, unsigned r, unsigned n, unsigned N, const boost::math::lanczos::undefined_lanczos&, const Policy& pol)
{
BOOST_MATH_STD_USING
return exp(
