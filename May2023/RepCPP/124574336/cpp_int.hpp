...
inline BOOST_MP_CXX14_CONSTEXPR void verify_new_size(unsigned , unsigned , const mpl::int_<unchecked>&) {}
...
template <class U>
inline BOOST_MP_CXX14_CONSTEXPR void verify_limb_mask(bool , U , U , const mpl::int_<unchecked>&) {}
