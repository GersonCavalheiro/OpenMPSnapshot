...
{
static const unsigned short ord[] = {2, 3, 4, 5, 7, 10, 12, 18, 10, 20, 30, 0, 4, 7, 8, 20, 0, 0}; 
...
{
static const unsigned short ord[] = {3, 4, 5, 6, 8, 11, 13, 19, 10, 20, 30,  0, 7, 10, 11, 23,  0, 0}; 
...
if(
(fabs(z) > last_z)     
|| (fabs(val) * tools::epsilon<RealType>() > fabs(c * s * z))  
|| (z * s < 0)         
)
{
break;
...
const unsigned short m = owens_t_get_order(icode, val , pol);
static const unsigned short meth[] = {1, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4, 4, 4, 4, 5, 6}; 
