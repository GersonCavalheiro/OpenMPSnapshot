...
virtual string_type convert(converter_base::conversion_type how,char_type const *begin,char_type const *end,int  = 0) const 
{
switch(how) {
...
virtual std::string convert(converter_base::conversion_type how,char const *begin,char const *end,int  = 0) const 
{
switch(how) {
case upper_case:
case lower_case:
