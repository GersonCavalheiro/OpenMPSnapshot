...
2*locDom->sizeX()*locDom->sizeY() + 
2*locDom->sizeX()*locDom->sizeZ() + 
2*locDom->sizeY()*locDom->sizeZ() ; 
...
const Index_t *cornerList = nodeElemCornerList.get_pointer() + nodeElemStart[gnode];
