...
enum IcOp {
ALLUIS = inner::genSysInstOp(0, 7, 1, 0), 
ALLU = inner::genSysInstOp(0, 7, 5, 0),   
VAU = inner::genSysInstOp(3, 7, 5, 0)     
};

enum DcOp {
IVAC = inner::genSysInstOp(0, 7, 0x6, 1),  
ISW = inner::genSysInstOp(0, 7, 0x6, 2),   
CSW = inner::genSysInstOp(0, 7, 0xA, 2),   
CISW = inner::genSysInstOp(0, 7, 0xE, 2),  
ZVA = inner::genSysInstOp(3, 7, 0x4, 1),   
CVAC = inner::genSysInstOp(3, 7, 0xA, 1),  
CVAU = inner::genSysInstOp(3, 7, 0xB, 1),  
CIVAC = inner::genSysInstOp(3, 7, 0xE, 1), 
CVAP = inner::genSysInstOp(3, 7, 0xC, 1)   
};

enum AtOp {
S1E1R = inner::genSysInstOp(0, 7, 0x8, 0),  
S1E1W = inner::genSysInstOp(0, 7, 0x8, 1),  
S1E0R = inner::genSysInstOp(0, 7, 0x8, 2),  
S1E0W = inner::genSysInstOp(0, 7, 0x8, 3),  
S1E2R = inner::genSysInstOp(4, 7, 0x8, 0),  
S1E2W = inner::genSysInstOp(4, 7, 0x8, 1),  
S12E1R = inner::genSysInstOp(4, 7, 0x8, 4), 
S12E1W = inner::genSysInstOp(4, 7, 0x8, 5), 
S12E0R = inner::genSysInstOp(4, 7, 0x8, 6), 
S12E0W = inner::genSysInstOp(4, 7, 0x8, 7), 
S1E3R = inner::genSysInstOp(6, 7, 0x8, 0),  
S1E3W = inner::genSysInstOp(6, 7, 0x8, 1),  
S1E1RP = inner::genSysInstOp(0, 7, 0x9, 0), 
S1E1WP = inner::genSysInstOp(0, 7, 0x9, 1), 
};

enum TlbiOp {
VMALLE1IS = inner::genSysInstOp(0, 7, 3, 0),    
VAE1IS = inner::genSysInstOp(0, 7, 3, 1),       
ASIDE1IS = inner::genSysInstOp(0, 7, 3, 2),     
VAAE1IS = inner::genSysInstOp(0, 7, 3, 3),      
VALE1IS = inner::genSysInstOp(0, 7, 3, 5),      
VAALE1IS = inner::genSysInstOp(0, 7, 3, 7),     
VMALLE1 = inner::genSysInstOp(0, 7, 7, 0),      
VAE1 = inner::genSysInstOp(0, 7, 7, 1),         
ASIDE1 = inner::genSysInstOp(0, 7, 7, 2),       
VAAE1 = inner::genSysInstOp(0, 7, 7, 3),        
VALE1 = inner::genSysInstOp(0, 7, 7, 5),        
VAALE1 = inner::genSysInstOp(0, 7, 7, 7),       
IPAS2E1IS = inner::genSysInstOp(4, 7, 0, 1),    
IPAS2LE1IS = inner::genSysInstOp(4, 7, 0, 5),   
ALLE2IS = inner::genSysInstOp(4, 7, 3, 0),      
VAE2IS = inner::genSysInstOp(4, 7, 3, 1),       
ALLE1IS = inner::genSysInstOp(4, 7, 3, 4),      
VALE2IS = inner::genSysInstOp(4, 7, 3, 5),      
VMALLS12E1IS = inner::genSysInstOp(4, 7, 3, 6), 
IPAS2E1 = inner::genSysInstOp(4, 7, 4, 1),      
IPAS2LE1 = inner::genSysInstOp(4, 7, 4, 5),     
ALLE2 = inner::genSysInstOp(4, 7, 7, 0),        
VAE2 = inner::genSysInstOp(4, 7, 7, 1),         
ALLE1 = inner::genSysInstOp(4, 7, 7, 4),        
VALE2 = inner::genSysInstOp(4, 7, 7, 5),        
VMALLS12E1 = inner::genSysInstOp(4, 7, 7, 6),   
ALLE3IS = inner::genSysInstOp(6, 7, 3, 0),      
VAE3IS = inner::genSysInstOp(6, 7, 3, 1),       
VALE3IS = inner::genSysInstOp(6, 7, 3, 5),      
ALLE3 = inner::genSysInstOp(6, 7, 7, 0),        
VAE3 = inner::genSysInstOp(6, 7, 7, 1),         
VALE3 = inner::genSysInstOp(6, 7, 7, 5),        
VMALLE1OS = inner::genSysInstOp(0, 7, 1, 0),    
VAE1OS = inner::genSysInstOp(0, 7, 1, 1),       
ASIDE1OS = inner::genSysInstOp(0, 7, 1, 2),     
VAAE1OS = inner::genSysInstOp(0, 7, 1, 3),      
VALE1OS = inner::genSysInstOp(0, 7, 1, 5),      
VAALE1OS = inner::genSysInstOp(0, 7, 1, 7),     
RVAE1IS = inner::genSysInstOp(0, 7, 2, 1),      
RVAAE1IS = inner::genSysInstOp(0, 7, 2, 3),     
RVALE1IS = inner::genSysInstOp(0, 7, 2, 5),     
RVAALE1IS = inner::genSysInstOp(0, 7, 2, 7),    
RVAE1OS = inner::genSysInstOp(0, 7, 5, 1),      
RVAAE1OS = inner::genSysInstOp(0, 7, 5, 3),     
RVALE1OS = inner::genSysInstOp(0, 7, 5, 5),     
RVAALE1OS = inner::genSysInstOp(0, 7, 5, 7),    
RVAE1 = inner::genSysInstOp(0, 7, 6, 1),        
RVAAE1 = inner::genSysInstOp(0, 7, 6, 3),       
RVALE1 = inner::genSysInstOp(0, 7, 6, 5),       
RVAALE1 = inner::genSysInstOp(0, 7, 6, 7),      
RIPAS2E1IS = inner::genSysInstOp(4, 7, 0, 2),   
RIPAS2LE1IS = inner::genSysInstOp(4, 7, 0, 6),  
ALLE2OS = inner::genSysInstOp(4, 7, 1, 0),      
VAE2OS = inner::genSysInstOp(4, 7, 1, 1),       
ALLE1OS = inner::genSysInstOp(4, 7, 1, 4),      
VALE2OS = inner::genSysInstOp(4, 7, 1, 5),      
VMALLS12E1OS = inner::genSysInstOp(4, 7, 1, 6), 
RVAE2IS = inner::genSysInstOp(4, 7, 2, 1),      
RVALE2IS = inner::genSysInstOp(4, 7, 2, 5),     
IPAS2E1OS = inner::genSysInstOp(4, 7, 4, 0),    
RIPAS2E1 = inner::genSysInstOp(4, 7, 4, 2),     
RIPAS2E1OS = inner::genSysInstOp(4, 7, 4, 3),   
IPAS2LE1OS = inner::genSysInstOp(4, 7, 4, 4),   
RIPAS2LE1 = inner::genSysInstOp(4, 7, 4, 6),    
RIPAS2LE1OS = inner::genSysInstOp(4, 7, 4, 7),  
RVAE2OS = inner::genSysInstOp(4, 7, 5, 1),      
RVALE2OS = inner::genSysInstOp(4, 7, 5, 5),     
RVAE2 = inner::genSysInstOp(4, 7, 6, 1),        
RVALE2 = inner::genSysInstOp(4, 7, 6, 5),       
ALLE3OS = inner::genSysInstOp(6, 7, 1, 0),      
VAE3OS = inner::genSysInstOp(6, 7, 1, 1),       
VALE3OS = inner::genSysInstOp(6, 7, 1, 5),      
RVAE3IS = inner::genSysInstOp(6, 7, 2, 1),      
RVALE3IS = inner::genSysInstOp(6, 7, 2, 5),     
RVAE3OS = inner::genSysInstOp(6, 7, 5, 1),      
RVALE3OS = inner::genSysInstOp(6, 7, 5, 5),     
RVAE3 = inner::genSysInstOp(6, 7, 6, 1),        
RVALE3 = inner::genSysInstOp(6, 7, 6, 5)        
};
