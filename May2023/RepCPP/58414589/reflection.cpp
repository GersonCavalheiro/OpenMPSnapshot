...
SC_CLASS_WITH_NAME(reflection_shared_general_obj, reflection::shared_general_object_t) 
SC_CLASS_END();
...
case basic_type::t_##TYPE: return visit(reinterpret_cast<TYPE *>(v->data_),  v2 ? reinterpret_cast<TYPE *>(v2->data_) : nullptr);  break; 
...
virtual bool visit(TYPE *v, TYPE *v2) override { return do_visit(v, v2); } 
