...
push	ebx
push	esi
mov		eax, dword ptr [esp + 4 * 2 + 8] 
cpuid
mov		esi, dword ptr [esp + 4 * 2 + 4] 
...
#include <cpuid.h>
#else
#if defined(__APPLE__) && defined(XBYAK32) 
...
if (has(tAMD)) {
dataCacheLevels_ = 3;
const uint32_t leaf = 0x8000001D; 
int cache_index = 0;
...
int actual_logical_cores = extractBit(data[0], 14, 25)  + 1;
if (logical_cores != 0) {
...
XBYAK_DEFINE_TYPE(21, tBMI1); 
XBYAK_DEFINE_TYPE(22, tBMI2); 
XBYAK_DEFINE_TYPE(23, tLZCNT);
XBYAK_DEFINE_TYPE(24, tINTEL);
XBYAK_DEFINE_TYPE(25, tAMD);
XBYAK_DEFINE_TYPE(26, tENHANCED_REP); 
XBYAK_DEFINE_TYPE(27, tRDRAND);
XBYAK_DEFINE_TYPE(28, tADX); 
XBYAK_DEFINE_TYPE(29, tRDSEED); 
XBYAK_DEFINE_TYPE(30, tSMAP); 
XBYAK_DEFINE_TYPE(31, tHLE); 
XBYAK_DEFINE_TYPE(32, tRTM); 
XBYAK_DEFINE_TYPE(33, tF16C); 
XBYAK_DEFINE_TYPE(34, tMOVBE); 
XBYAK_DEFINE_TYPE(35, tAVX512F);
XBYAK_DEFINE_TYPE(36, tAVX512DQ);
XBYAK_DEFINE_TYPE(37, tAVX512_IFMA);
XBYAK_DEFINE_TYPE(37, tAVX512IFMA);
...
XBYAK_DEFINE_TYPE(43, tAVX512VBMI); 
