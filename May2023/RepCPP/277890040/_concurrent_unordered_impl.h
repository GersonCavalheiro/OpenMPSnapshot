...
void erase_node(raw_iterator previous, raw_const_iterator& where) {
erase_node(previous, where, tbb::internal::true_type());
}
...
return erase_node(previous, where, tbb::internal::true_type());
}
...
typename tbb::internal::allocator_rebind<allocator_type, node>::type my_node_allocator; 
...
return internal_insert<tbb::internal::true_type,
tbb::internal::true_type>(value);
}
...
return internal_insert<tbb::internal::true_type,
tbb::internal::true_type>(std::move(value));
}
...
internal_insert<tbb::internal::false_type,
tbb::internal::false_type>
...
return internal_insert<tbb::internal::false_type,
tbb::internal::true_type>(pnode->my_element, pnode);
}
...
pairii_t where = equal_range(key);
if (where.first == end()) return node_type(); 
...
my_solist.erase_node(previous, it, tbb::internal::false_type());
...
solist_t                                                      my_solist;                  
typename tbb::internal::allocator_rebind<allocator_type, raw_iterator>::type my_allocator; 
