...
const double contention_unit = 0.025; 
const double throughput_window = 30; 
const int num_initial_events = 10000; 
const int min_elapse = 20; 
const int max_elapse = 40; 
const int min_spawn = 0; 
