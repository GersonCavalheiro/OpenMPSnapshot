...
TObjectOrder maxObj,
bool& drawCaution,                      
std::vector< std::vector< TSemanticValue > >& valuesToDraw, 
std::vector< hash_set< PRV_INT32 > >& eventsToDraw,    
std::vector< hash_set< commCoord > >& commsToDraw,    
...
bool& drawCaution,                                  
std::vector< std::vector< TSemanticValue > >& valuesToDraw,             
std::vector< std::unordered_set< PRV_INT32 > >& eventsToDraw,                
std::vector< std::unordered_set< commCoord, hashCommCoord > >& commsToDraw,    
ProgressController *progress )
#endif
{}
...
TObjectOrder maxObj,
bool& drawCaution,                      
std::vector< std::vector< std::vector< std::pair<TSemanticValue,TSemanticValue> > > >& valuesToDraw, 
std::vector< hash_set< PRV_INT32 > >& eventsToDraw,    
std::vector< hash_set< commCoord > >& commsToDraw,    
ProgressController *progress )
#else
...
virtual void setShowChildrenWindow( bool newValue ) override; 
...
virtual bool existsCFG4DAlias( const std::string &property ) const override; 
...
virtual std::string getCFG4DAlias( const std::string &property ) const override; 
...
int& rowComputedZeros,
std::vector< std::vector< std::pair<TSemanticValue,TSemanticValue> > >& valuesToDraw, 
...
TSemanticValue &rowComputedMinY,
int& rowComputedZeros,
std::vector< TSemanticValue >& valuesToDraw, 
hash_set< PRV_INT32 >& eventsToDraw,    
hash_set< commCoord >& commsToDraw,
ProgressController *progress );   
