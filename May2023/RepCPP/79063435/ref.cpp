...
VERIFY_EVALUATION_COUNT( call_ref_2(A*A.col(1), tmp), 1);     
...
tmp = a+a;
VERIFY_EVALUATION_COUNT( call_ref_2(a+a,tmp), 1);            
VERIFY_EVALUATION_COUNT( call_ref_2(ca.imag(),ca.imag()), 1);      

VERIFY_EVALUATION_COUNT( call_ref_4(ac.head(5),ac.head(5)), 0);
tmp = a+a;
VERIFY_EVALUATION_COUNT( call_ref_4(a+a,tmp), 1);           
...
VERIFY_EVALUATION_COUNT( call_ref_5(b,b), 0);             
...
VERIFY_EVALUATION_COUNT( call_ref_6(A.row(3),A.row(3)), 1);           
tmp = A+A;
VERIFY_EVALUATION_COUNT( call_ref_6(A+A,tmp), 1);                
VERIFY_EVALUATION_COUNT( call_ref_6(A,A), 0);
VERIFY_EVALUATION_COUNT( call_ref_6(A.transpose(),A.transpose()), 1);      
