...
{
ind_2  = ind_1 + j;
norm_simi = simi_matrix(i,j)/(latent_simi_sum(i) + rolled_simi_sum(j) - simi_matrix(i,j)+0.000001); 
...
for(i=0; i<topN ; ++i)
{
ind_1 = y[i]/rolled_minu_template.m_nrof_minu; 
ind_2 = y[i] - ind_1*rolled_minu_template.m_nrof_minu; 
...
register float dist0=0.0, dist1= 0.0, dist2= 0, dist3=0.0, dist4 = 0.0; 
...
{
fp_template.release();
const short Max_Nrof_Minutiae = 2*1000; 
