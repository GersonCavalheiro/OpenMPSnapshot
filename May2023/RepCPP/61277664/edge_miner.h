...
typedef PerThreadStorage<QpMapFreq> LocalQpMapFreq; 
typedef PerThreadStorage<CgMapFreq> LocalCgMapFreq; 
...
LocalInitMap init_localmaps; 
LocalQpMapDomain qp_localmaps; 
LocalCgMapDomain cg_localmaps; 
QpMapDomain qp_map; 
CgMapDomain cg_map; 
std::mutex map_mutex;
