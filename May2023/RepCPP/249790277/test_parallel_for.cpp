...
try{
tbb::parallel_for(static_cast<T>(1), static_cast<T>(100), static_cast<T>(0), TestFunctor<T>());  
...
template <typename RangeType, bool , bool ensure_non_emptiness>
void test() {
...
using uniform_distribution::test; 
#else
...
correctness::test<Range1_2,  false, !ensure_non_empty_range>();
correctness::test<Range1_999,  false, !ensure_non_empty_range>();
correctness::test<Range999_1,  false, !ensure_non_empty_range>();
