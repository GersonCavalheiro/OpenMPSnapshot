...
object_instances_counting_type(): m_p_count (new counter_type){*m_p_count =1; } 
...
struct dummy_function{static int _(int ){return 0xDEADBEEF;}};
typedef get_lru_cache_type::apply<int,int>::type cache_type;
size_t number_of_lru_history_items = 8;
int dummy_key=1;
cache_type cache((&dummy_function::_),(number_of_lru_history_items));
...
static const size_t number_of_threads = 4 * tbb::task_scheduler_init::default_num_threads(); 
